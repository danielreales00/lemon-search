...
<Frame caption="A live result list for 'coffee': rank badges, ratings, distance, open status, and the synthesized claimed and friends signals shown as chips.">
  <img src="/images/app-results.png" alt="Lemon Search ranked results for coffee" noZoom />
</Frame>
