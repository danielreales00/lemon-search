...
| "fancy dinner" | intent | Downtown Miami | (no results — lexical baseline, no semantic layer) |
| "date night" | intent | Downtown Miami | 8.97 / 9.74 | 0.842 | 0.512 | 80% | 100% | date_night:n/a | 0% | no | 1.00 | — |
| "i'm hungry" | intent | Downtown Miami | (no results — lexical baseline, no semantic layer) |
...
| "somewhere to get pampered" | vibe | Downtown Miami | (no results — lexical baseline, no semantic layer) |
